...
inline std::array<Patch, kPresetCount> MakeDefaultUserPresetBank()
{
  ...
  bank[0].master_volume = 0.74f;
  bank[0].osc_a.waveform = Waveform::Saw;
  bank[0].osc_b.waveform = Waveform::Triangle;
  bank[0].osc_b.level = 0.46f;
  bank[0].osc_b.fine_tune_cents = 3.0f;
  bank[0].filter.cutoff = 0.58f;
  bank[0].filter.resonance = 0.22f;
  bank[0].amp_env.attack_s = 0.45f;
  bank[0].amp_env.sustain = 0.74f;
  ...
  bank[0].chorus.mix = 0.30f;
  bank[0].delay.mix = 0.14f;
  bank[0].delay.feedback = 0.24f;
  bank[0].reverb.mix = 0.24f;

  bank[1].name = "Glass Keys";
  bank[1].master_volume = 0.76f;
  bank[1].osc_a.waveform = Waveform::Triangle;
  bank[1].osc_b.waveform = Waveform::Sine;
  bank[1].osc_b.level = 0.34f;
  bank[1].osc_b.octave = 1;
  bank[1].filter.cutoff = 0.68f;
  bank[1].filter.resonance = 0.24f;
  bank[1].amp_env.attack_s = 0.006f;
  bank[1].amp_env.decay_s = 0.22f;
  bank[1].amp_env.sustain = 0.18f;
  bank[1].amp_env.release_s = 0.28f;
  ...
  bank[1].delay.mix = 0.16f;
  bank[1].delay.feedback = 0.22f;
  bank[1].reverb.mix = 0.10f;

  bank[2].name = "Phantom Brass";
  bank[2].master_volume = 0.68f;
  ...
  bank[3].filter.env_amount = 0.54f;
  bank[3].amp_env.attack_s = 0.004f;
  bank[3].amp_env.decay_s = 0.12f;
  bank[3].amp_env.sustain = 0.68f;
  bank[3].amp_env.release_s = 0.14f;
  bank[3].osc_lfo.amount = 0.12f;
  bank[3].osc_lfo.rate_hz = 5.2f;
  bank[3].delay.sync_mode = SyncMode::Free;
  bank[3].delay.time_ms = 160.0f;
  bank[3].delay.feedback = 0.22f;
