...
| Interface | Potentiomètres | `Alpha RD901F-40-15F-B10K-00DL1` | 8 | 10 | Indispensable | `10k` linéaire, axe plat `6 mm`, panneau |
| Interface | Encodeur rotatif | `Bourns PEC11R-4225F-S0024` | 1 | 2 | Indispensable | encodeur cranté avec switch |
| Interface | Boutons poussoirs | `APEM IPR3FAD7/1` | 4 | 6 | Indispensable | boutons de panneau momentané `NO` |
| Interface | Écran OLED | `BuyDisplay ER-OLEDM013-1W-I2C` | 1 | 1 à 2 | Indispensable | module `1,3"` `128x64` `I2C`, contrôleur `SH1106` |
| Audio | Sortie audio | `Switchcraft 155` | 1 | 1 | Indispensable | jack TRS stéréo `6,35 mm` |
| MIDI | Connecteur MIDI In | `Switchcraft 57GB5FX` | 1 | 1 | Indispensable | embase DIN 5 de panneau |
| MIDI | Optocoupleur | `onsemi H11L1M` | 1 | 2 | Indispensable | optocoupleur logique `3,3 V` |
| MIDI | Résistance boucle MIDI | `220R` | 1 | 2 à 4 | Indispensable | conforme à la convention MIDI In |
| MIDI | Pull-up sortie opto | `1k` | 1 | 2 à 4 | Indispensable | choix retenu pour la sortie `H11L1M` |
| MIDI | Diode inverse | `1N4148` | 1 | 2 à 4 | Indispensable | protection inverse LED d'entrée opto |
| MIDI | Condensateur MIDI In | `100nF` | 1 | 2 à 4 | Indispensable | découplage local de l'optocoupleur |
| Signalisation | LED MIDI | `Kingbright WP710A10ID` | 1 | 2 à 4 | Indispensable | LED rouge diffuse `3 mm` |
| Signalisation | Résistance LED MIDI | `1k` | 1 | 2 à 4 | Indispensable | courant modéré et lisible à `3,3 V` |
...
Ces éléments existent bien dans l'architecture V1, mais certains détails restent encore liés au dessin exact du schéma ou de la mécanique.

| Élément | Direction actuelle | Statut |
|---|---|---|
| Circuit MIDI In | `57GB5FX` + `H11L1M` + `220R` + `1k` + `1N4148` + `100nF` | Figé, à dessiner |
| Étage de sortie audio | routage direct `Seed pin 18/19/20 -> jack 155` | Figé, à dessiner |
| Alimentation finale | prototype via USB, alimentation finale à définir | À figer |
| Référence exacte de l'OLED | `ER-OLEDM013-1W-I2C` | Figé |
| Référence exacte des potentiomètres | `RD901F-40-15F-B10K-00DL1` | Figé |
| Référence exacte de l'encodeur | `PEC11R-4225F-S0024` | Figé |
| Référence exacte des boutons | `IPR3FAD7/1` | Figé |
