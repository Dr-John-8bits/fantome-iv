...
- désormais compatible avec une pin map, un MIDI In et une sortie audio déjà figés
...
- d'afficher l'UI sur `OLED 128x64 1,3" I2C`
...
- un optocoupleur `H11L1M`
- la résistance de boucle `220R`
- le pull-up de sortie `1k`
- la diode inverse `1N4148`
...
### 5.4 Référence de détail

Le détail de ce bloc est figé dans [MIDI-IN-HARDWARE-SPEC.md](./MIDI-IN-HARDWARE-SPEC.md).
...
### 6.4 Référence de détail

Le détail de ce bloc est figé dans [AUDIO-OUT-SPEC.md](./AUDIO-OUT-SPEC.md).
...
### 7.5 Référence retenue

- module retenu : `ER-OLEDM013-1W-I2C`
- contrôleur retenu : `SH1106`
- pin map retenue : voir [PINMAP-DAISY.md](./PINMAP-DAISY.md)
...
Le brochage exact est documenté dans [PINMAP-DAISY.md](./PINMAP-DAISY.md).
